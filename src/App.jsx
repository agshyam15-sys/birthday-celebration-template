    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">M</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">M's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>A small present for you, Hope you like it! 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Shy 💖</h2>
          <p className="final-subtitle">My Heart, I like you, A lottt!! ✨</p>
        </section>
      </div>
